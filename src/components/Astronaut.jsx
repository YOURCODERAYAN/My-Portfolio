...
// This section is for falling animation //
  const yPosition = useMotionValue(5); // It should start from this initial position
  const ySpring = useSpring(yPosition,{damping:6}) // and using this spring animation we can set like damp 30 for better smooth effect
