...
export const GlareCard = ({
  ...
  return (
    <div
      ...
      className="relative isolate [aspect-ratio:17/21] w-[100px] transition-transform delay-[var(--delay)] duration-[var(--duration)] ease-[var(--easing)] will-change-transform [contain:layout_style] [perspective:600px]"
      ref={refElement}
      onPointerMove={(event) => {
      ...
      <div
        ...
        <div
          ...
          <div className={cn("h-full w-full bg-cyan-500", className)}>
            {children}
          </div>
        </div>
        <div
